...
namespace Transport_Booking.Server.Data.Migrations
{
    ...
    [Migration("20240122042957_AddedDefaultDataAndUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transport_Booking.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Transport_Booking.Shared.Domain.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Transport_Booking.Shared.Domain.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Transport_Booking.Server.Models.ApplicationUser", null)
                        .WithMany()
